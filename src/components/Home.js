...
function Home() {
    ...
    const YouTube = "https://youtube.com/@EasyCode_";
    const Github = "https://github.com/EasyCode0x7/EasyCode-homepage";

    return (
        <div>

            <nav path="/" className='navbar dos fixed-top navbar-expand py-3 mx-auto w-50 d-flex justify-content-evenly' style={{background: "#20202380", backdropFilter: "blur(4px)"}}>
                <a 
                    href="/" 
                    className="ssS fs-5 fw-bolder text-white">
                        DevelopedbyDe
                </a>

                <ul class="navbar-nav nav-pills gap-3" style={{fontSize: "1.2em"}}>
            ...
            <div className='content text-center mx-auto'>
                ...
                <div className='text-start h2-text pt-3 pb-1 d-flex align-items-center justify-content-between'>
                    <h2 className='fw-bold' style={{fontSize: "3em"}}>Juan Alberto<p className="pt-1">Digital Craftsman ( / Developer / Pentester )</p></h2>
                    <img className='avatar rounded-circle img-responsive' style={{paddingBottom: "15px"}} src={deved} />
                </div>

                <div className='uno' style={{width: "100%"}}>
            ...
            <div className='identificador gap-5 py-4 d-flex fs-1 align-items-center h-50'>
                ...
                <a href={YouTube}><i class="fa-brands fa-youtube onit youtube"></i></a>
            </div>
