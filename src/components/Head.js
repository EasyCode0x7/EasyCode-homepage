    ...
    return(
        <div>
            ...
            <nav path="/" className='nav-principal fs22 rounded d-flex align-items-center justify-content-between'>
                <h2 className='fs-5'>
                    <a href="/" className="ssS">
                        <p className="">DevelopedbyDe</p>
                    </a>
                </h2>
                <ul class="nav nav-pills">
                    <li class="nav-item rounded list-group-item-primary">
                        <a class="nav-link" href="/resume"><BsFillMoonStarsFill /></a>
                    </li>
                </ul>
            </nav>
            ...
            <div className='content text-center mx-auto'>
                ...
                <div className='h3-text m-0 fs22 d-flex justify-content-between rounded' style={{paddingBottom: "0.8rem", paddingTop: "0.8rem"}}>
                ...
                <div className='text-start h2-text pt-4 d-flex align-items-center justify-content-between'>
                    <h2>Juan Alberto<p className="p">Digital Craftsman ( / Developer / Pentester )</p></h2>
                    <img className='avatar rounded-circle img-responsive' src={deved} />
                </div>

                <div style={{width: "420px"}}>
                    <p className='wxTrs fs-6 text-start'>
